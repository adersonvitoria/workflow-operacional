...
export const SEED_CARDS: Card[] = [
  ...
  full({ id: "man-1", codigo: "OS-11269", fluxo: "MANUTENCAO", etapa: "APONTAMENTO", status: "EM_ANDAMENTO", prioridade: "NORMAL", cliente: { nome: "DIAMANTINO DUARTE FERNANDES" }, cr: "32643", valores: { total: 260 }, responsavelAtual: { setor: "TECNICA", pessoa: "Daniel Chagas" } }),
  full({ id: "man-2", codigo: "ORÇ-261", fluxo: "MANUTENCAO", etapa: "ORCAMENTACAO", status: "EM_ANDAMENTO", prioridade: "NORMAL", cliente: { nome: "FIX IT" }, cr: "8133", valores: { total: 639 }, responsavelAtual: { setor: "COMERCIAL", pessoa: "Eduardo Menezes" } }),
  full({ id: "man-3", codigo: "ORÇ-224", fluxo: "MANUTENCAO", etapa: "APROVACAO_CLIENTE", status: "AGUARDANDO_APROVACAO", prioridade: "NORMAL", cliente: { nome: "MARCIA SCARPARO" }, cr: "7500", valores: { total: 978 }, responsavelAtual: { setor: "COMERCIAL", pessoa: "Aline Guedes" } }),
