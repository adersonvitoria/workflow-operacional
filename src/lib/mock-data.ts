...
export const SEED_CARDS: Card[] = [
  ...
  full({ id: "man-4", codigo: "OS-9201", fluxo: "MANUTENCAO", etapa: "AGENDAMENTO", status: "EM_ANDAMENTO", prioridade: "URGENTE", cliente: { nome: "HIGIEFARM" }, cr: "9201", valores: { total: 320 }, responsavelAtual: { setor: "ADMINISTRATIVO", pessoa: "Maurício Fuculo" } }),
