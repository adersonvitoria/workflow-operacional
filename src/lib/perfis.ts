...
export const TODAS_ETAPAS: EtapaId[] = [
  ...
  "SEPARACAO", "CLASSIFICACAO", "PEDIDO_FORNECEDOR", "ENTREGA", "TABELA_VALORES", "REVISAO_VALORES", "SOLICITACAO_COMPRA", "PEDIDO_COMPRA", "PC_ENVIADO",
  "MEDICAO", "ENCERRADOS",
];
...
export const CONFIG_PADRAO: Record<Perfil, PerfilConfig> = {
  ...
  SUPRIMENTOS: { etapas: ["SUPRIMENTOS", "PEDIDO_FORNECEDOR", "ENTREGA", "TABELA_VALORES", "REVISAO_VALORES", "SOLICITACAO_COMPRA", "PEDIDO_COMPRA", "PC_ENVIADO"], capacidades: cap({}), acoes: PERFIL_META.SUPRIMENTOS.acoes },
